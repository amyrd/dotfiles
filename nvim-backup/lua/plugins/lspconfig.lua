...
return {
  ...
  },
  {
    ...
    dependencies = {
      -- Use the new mason-org repositories
      { 'mason-org/mason.nvim', opts = {} },
      {
        'mason-org/mason-lspconfig.nvim',
        opts = {
          ensure_installed = { 'lua_ls' }, -- Add other servers you want here
          automatic_enable = true, -- Let mason-lspconfig automatically enable servers
        },
      },
    ...
    config = function()
      -- Your existing LspAttach autocmd
      ...
      -- Configure specific servers (only if you need custom settings)
